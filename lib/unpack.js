...
class Unpack extends Parser {
  ...
  // against and the literal contents of a symbolic link.  An absolute or
  // '..'-bearing linkpath escapes the extraction target just as surely as an
  // absolute or '..'-bearing path does, so both go through the same check.
